...
public extension UIWindow {
    ...
    public func setRootViewController(_ controller: UIViewController?,transitionWnd: UIWindow, options: TransitionOptions = TransitionOptions()) {
    ...
    ///   - controller: controller to set
    ///   - options: options of the transition
    public func hideVappWindow(_ transitionWnd: UIWindow, options: TransitionOptions = TransitionOptions()) {
      ...
      case .snapshot:
        ...
        transitionWnd.windowLevel = UIWindow.Level.normal;
        
       
            DispatchQueue.main.asyncAfter(deadline: (.now() + 1 + options.duration), execute: {
                transitionWnd.removeFromSuperview()
            })
